...
export interface IUser extends Document {
  ...
  pickupAddresses?: Array<{
    ...
    courierCartPickupAddressId?: string // CourierCart pickup address ID for syncing
  }>
    ...
    pickupAddresses: [
      {
        ...
        courierCartPickupAddressId: { type: String }, // CourierCart pickup address ID for syncing
      },
    ],
