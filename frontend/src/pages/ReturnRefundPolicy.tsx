...
const ReturnRefundPolicy = () => {
  const {
    ...
    queryKey: ['agreement', 'customer-return-refund-policy'],
    queryFn: () => getAgreementByType('customer-return-refund-policy'),
    retry: false,
  })

  useEffect(() => {
    if (agreement) {
      document.title = agreement.title || 'Return & Refund Policy'
    } else {
      ...
      <div className="min-h-screen bg-gradient-to-b from-gray-50 via-white to-gray-50 py-36">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <div className="bg-white rounded-2xl shadow-lg p-12">
            <RefreshCw className="w-16 h-16 mx-auto mb-6 text-gray-400" />
            ...
            <p className="text-gray-600 mb-8 text-lg">
              {error
                ? (error as Error)?.message ||
                  'Return and refund policy is not available at this time. Please check back later or contact support.'
                : 'Return and refund policy is currently being updated. Please check back later.'}
            </p>
            <Link to="/">
  ...
  return (
    <div className="min-h-screen mt-4 bg-gradient-to-b from-gray-50 via-white to-gray-50">
      {/* Hero Section */}
      <div className="relative">
        <div className="relative h-64 md:h-80 bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900">
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="text-center px-4">
              <RefreshCw className="w-12 h-12 md:w-16 md:h-16 mx-auto mb-4 text-white opacity-90" />
