...
export default function DiscrepancyDetails() {
  const BRAND_PURPLE = '#B78115'
  const BRAND_ORANGE = '#555D61'
  const shellCardSx = {
    borderRadius: 5,
      ...
      <Stack gap={3}>
        <Box
          sx={{
            ...
            border: `1px solid ${alpha(BRAND_PURPLE, 0.12)}`,
            background:
              'radial-gradient(circle at top right, rgba(49, 2, 118,0.14) 0%, transparent 24%), linear-gradient(180deg, rgba(255,255,255,0.98) 0%, rgba(248,243,240,0.98) 100%)',
            boxShadow: '0 18px 38px rgba(20, 20, 20, 0.08)',
          }}
        >
          <Button
          ...
          <CardContent>
            ...
            >
              ...
              <Box>
                ...
                <Typography sx={{ fontWeight: 600, color: '#B78115' }}>
        ...
        <Card sx={{ boxShadow: '0 2px 8px rgba(0,0,0,0.06)' }}>
          <CardContent>
            <Typography variant="h6" sx={{ fontWeight: 700, color: '#B78115', mb: 3 }}>
              Weight Comparison
            </Typography>
            <Box
              sx={{
            ...
            >
              <Box>
                ...
                <Typography variant="h6" sx={{ fontWeight: 700, color: '#B78115' }}>
        ...
        {discrepancy.courier_remarks && (
          <Card sx={shellCardSx}>
            <CardContent>
              <Typography variant="h6" sx={{ fontWeight: 700, color: '#B78115', mb: 2 }}>
                Courier Remarks
              </Typography>
            ...
            <CardContent>
              {!showDisputeForm ? (
                <Stack direction="row" alignItems="center" justifyContent="space-between">
                  <Box>
                    <Typography variant="h6" sx={{ fontWeight: 700, color: '#B78115', mb: 1 }}>
