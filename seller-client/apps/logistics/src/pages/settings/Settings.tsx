...
const allSettings: SettingItem[] = [
  ...
  // Connections & routing
  {
    ...
    description: 'Review store connections and manage how order sources flow into Kourier Boyz.',
      ...
      <Stack spacing={1.35}>
        <Box
          sx={{
            ...
            placeItems: 'center',
            color: '#B78115',
            bgcolor: alpha('#B78115', 0.08),
            border: `1px solid ${alpha('#B78115', 0.12)}`,
          }}
        >
          {item.icon}
        </Box>
        ...
        <Typography sx={{ fontSize: '0.88rem', color: '#626966', lineHeight: 1.55 }}>
          {item.description}
        </Typography>
      </Stack>
    </Paper>
