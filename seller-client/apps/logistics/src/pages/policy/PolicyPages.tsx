    ...
    <Container maxWidth="lg" sx={{ py: 4 }}>
      ...
      >
        <PageHeading
          ...
          subtitle="All policies, terms, privacy details, and company information for Kourier Boyz in one clear, professional reference space."
        />
      ...
      <Box sx={{ mt: 4 }}>
        ...
        <Typography paragraph>
          • Kourier Boyz reserves the right to modify, suspend, or terminate the Service for any reason,
          without prior notice at any time.
        </Typography>
        <Typography paragraph>
          • Fraud Prevention: Without limiting any other remedies, Kourier Boyz may suspend or terminate
      ...
      <Box sx={{ mt: 4 }}>
        ...
        <Typography paragraph>
          Kourier Boyz ("we," "our," or "us") operates the services offered via our website and related
