 ...
 * Checks both kourierBoyzLogistics.awb_number and shippingMeta.awb
 */
export function getAWBGeneratedAt(shipment: IShipment | IOrderSellerShipment): Date | null {
  // Check if AWB exists in kourierBoyzLogistics
  if ('kourierBoyzLogistics' in shipment && shipment.kourierBoyzLogistics?.awb_number) {
