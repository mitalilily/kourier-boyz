...
const RequestPickupModal = ({
  ...
  const handleConfirmPickup = useCallback(async () => {
    ...
    try {
      ...
      // we use the first group's pickupId (CourierCart ID) or warehouseId (MongoDB _id or CourierCart ID)
      // Backend will handle matching by either _id or courierCartPickupAddressId
