...
const TdsReport = () => {
  ...
  const {
    ...
    queryKey: ['tdsReport', queryParams],
      ...
      <html>
        ...
        <body>
          ...
          <p style="margin-top: 20px;">
            <strong>Summary:</strong> ${totals?.sellerCount || 0} sellers, ${
  ...
  const columns: ColumnsType<TdsReportRow> = [
    ...
    },
    {
      ...
      filters: [
        ...
        { text: 'Threshold Crossed', value: 'Threshold Crossed' },
      ],
      onFilter: (value, record) => record.tdsDeductionStatus === value,
    },
    {
      ...
      <Card>
        <Space direction="vertical" size="large" style={{ width: '100%' }}>
          ...
          <Table
            ...
            dataSource={rows}
            loading={isLoading}
            rowKey={(record) => `${record.sellerId}-${record.financialYear}`}
            scroll={{ x: 1500 }}
            pagination={{
              pageSize: 50,
