    ...
    autoAccepted ? '#28a745' : isLargeDiscrepancy ? '#ffc107' : '#0dcaf0'
      ...
      <body>
        <div class="container">
          ...
          <div class="footer">
            <p>This is an automated notification from the Kourier Boyz weight reconciliation system.</p>
  ...
  const html = `
      ...
      <body>
        <div class="container">
          ...
          <div class="footer">
            <p>This is an automated daily summary from Kourier Boyz.</p>
  ...
  const html = `
      ...
      <body>
        <div class="container">
          ...
          <div class="footer">
            <p>This is an automated weekly report from Kourier Boyz.</p>
            <p>You can manage email preferences in your <a href="${
              process.env.FRONTEND_URL || 'http://localhost:5173'
            }/reconciliation/weight/settings">settings</a></p>
            <p>© ${new Date().getFullYear()} Kourier Boyz. All rights reserved.</p>
