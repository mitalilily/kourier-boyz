...
export const generateInvoiceForUser = async (
  ...
  const issuerName = adminPrefs?.brandName || 'Kourier Boyz'
  ...
  // Platform (Kourier Boyz) logo for footer branding from admin billing preferences
  ...
  const docDefinition: any = {
    ...
    content: isThermal
      ...
      : [
          ...
          // FOOTER
          {
            text: 'Thank you for trusting and doing business with Kourier Boyz.',
            style: 'footer',
          },
