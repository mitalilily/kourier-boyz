      ...
      <Stack gap={3}>
        ...
        >
          ...
          <Typography variant="body2" sx={{ color: '#6B7280', mt: 0.5, fontSize: '14px' }}>
            Configure thresholds, alerts, and reporting rules with a cleaner Kourier Boyz workflow.
          </Typography>
          ...
          <Stack gap={3}>
            <Box sx={sectionCardSx}>
              ...
              {formData.autoAcceptEnabled && (
                <Alert
                  ...
                  sx={{
                    ...
                    borderLeft: '4px solid #B78115',
                    '& .MuiAlert-icon': {
                      color: '#B78115',
                    },
                  }}
                >
                  <Typography variant="body2" sx={{ fontWeight: 600, color: '#B78115', mb: 1 }}>
              ...
              <Stack gap={3}>
                ...
                >
                  <Box>
                    <Typography sx={{ fontWeight: 600, color: '#B78115', mb: 0.5 }}>
                      Enable Auto-Accept
                    </Typography>
                ...
                {formData.autoAcceptEnabled && (
                  <>
                    ...
                    <Box>
                      <Typography
                        sx={{ fontWeight: 600, color: '#B78115', mb: 1.5, fontSize: '14px' }}
                      >
                        Weight Threshold (kg)
                      </Typography>
                      <TextField
