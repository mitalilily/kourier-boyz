...
export const BankAccountsSection: React.FC = () => {
  ...
  return (
    <Stack spacing={3} width={'100%'}>
      ...
      >
        <Stack spacing={0.4}>
          <Typography sx={{ fontSize: '0.72rem', letterSpacing: '0.16em', fontWeight: 800, color: '#555D61', textTransform: 'uppercase' }}>
            Settlement accounts
          </Typography>
          ...
          <Typography sx={{ fontSize: '0.92rem', color: '#4B5563' }}>
            Control where Kourier Boyz settles funds and which account remains primary for operations.
          </Typography>
        </Stack>
