      ...
      {iconOnly ? (
        ...
        <Box
          sx={{
            ...
            '&:hover': {
              background: `rgba(49, 2, 118, 0.06)`,
              borderColor: `rgba(49, 2, 118, 0.15)`,
              boxShadow: `0 8px 20px rgba(49, 2, 118, 0.1)`,
              transform: 'translateY(-2px)',
            },
          }}
          onClick={() => setDialogOpen(true)}
        >
          ...
          <Button
            ...
            sx={{
              ...
              boxShadow: '0 6px 14px rgba(49, 2, 118, 0.18)',
              ...
              '&:hover': {
                ...
                boxShadow: '0 10px 20px rgba(49, 2, 118, 0.25)',
