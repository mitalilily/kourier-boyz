...
const buildAmazonWarehousePayload = (pickupAddr: any, rtoAddressData?: any) => ({
  ...
  contactName: pickupAddr.contactName || 'Kourier Boyz',
  ...
  companyName: pickupAddr.addressNickname || pickupAddr.contactName || 'Kourier Boyz',
  returnAddress: rtoAddressData
    ? {
        ...
        contactName: rtoAddressData.contactName || pickupAddr.contactName || 'Kourier Boyz',
        ...
        companyName: rtoAddressData.addressNickname || rtoAddressData.contactName || 'Kourier Boyz',
      }
    : undefined,
})
