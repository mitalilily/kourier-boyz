...
// Extended PickupAddress type that includes MongoDB _id and kourierBoyzLogisticsPickupAddressId
...
const InventoryTab = ({ form, variants, onVariantsChange }: InventoryTabProps) => {
  ...
  const getWarehouseId = (addr: PickupAddressWithId, index?: number): string => {
    ...
    // Fallback: use kourierBoyzLogisticsPickupAddressId if available
    if (addr.kourierBoyzLogisticsPickupAddressId) {
      return String(addr.kourierBoyzLogisticsPickupAddressId)
    }
