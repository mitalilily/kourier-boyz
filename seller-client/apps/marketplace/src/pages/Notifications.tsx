...
const getNotificationIcon = (type?: string) => {
  switch (type) {
    case 'order':
      return <ShoppingOutlined style={{ fontSize: 20, color: '#4F5552' }} />
    case 'system':
        ...
        >
          <div>
            <Title level={2} style={{ margin: 0, display: 'flex', alignItems: 'center', gap: 12 }}>
              <BellOutlined style={{ fontSize: 28, color: '#4F5552' }} />
              Notifications
              {unreadCount > 0 && (
                <Badge
                  count={unreadCount}
                  ...
                  {notifications.map((notification) => (
                    <Card
                      ...
                      style={{
                        ...
                        border: notification.read ? '1px solid #e5e7eb' : '1px solid #4F5552',
