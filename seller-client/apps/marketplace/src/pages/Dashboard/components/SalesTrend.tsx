        ...
        >
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
              <div style={{ width: 8, height: 8, borderRadius: '50%', background: '#B78115' }} />
              <span style={{ fontSize: 12, color: '#666' }}>Sales:</span>
              <strong style={{ fontSize: 13, color: '#B78115', marginLeft: 'auto' }}>
      ...
      title={
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            ...
            >
              <LineChartOutlined style={{ color: '#B78115', fontSize: 18 }} />
            </div>
          ...
          <LineChart data={chartData} margin={{ top: 10, right: 20, bottom: 10, left: 0 }}>
            <defs>
              <linearGradient id="salesGradient" x1="0" y1="0" x2="0" y2="1">
                <stop offset="5%" stopColor="#B78115" stopOpacity={0.2} />
                <stop offset="95%" stopColor="#B78115" stopOpacity={0} />
              </linearGradient>
            </defs>
            ...
            <Line
              ...
              stroke="#B78115"
              strokeWidth={3}
              dot={{ fill: '#B78115', r: 5, strokeWidth: 2, stroke: 'white' }}
              activeDot={{ r: 7, strokeWidth: 2, stroke: 'white', fill: '#B78115' }}
              name="Sales"
            />
          </LineChart>
        </ResponsiveContainer>
