...
const AboutUsEditor = () => {
  ...
  const handleLoadTemplate = () => {
    const templateHtml = `
      <h2>About Kourier Boyz</h2>
      <p><strong>Kourier Boyz</strong> is a courier aggregator technology platform designed to help entrepreneurs, D2C brands, and logistics businesses run a branded shipping operation with a cleaner and more scalable software stack.</p>
      ...
      <p><strong>Email:</strong> hello@kourier-boyz.in</p>
      <p><strong>Website:</strong> kourier-boyz.in</p>
    `
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await updatePageMutation.mutateAsync({ title: 'About Us – Kourier Boyz', content })
      toast({
