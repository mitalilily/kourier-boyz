      ...
      >
        {collapsed ? (
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            ...
            />
            <div>
              <div style={{ fontSize: 16, fontWeight: 700, color: '#1890ff', lineHeight: '20px' }}>
                Seller
              </div>
              <div
                style={{ fontSize: 10, color: '#ffdc3b', fontWeight: 600, letterSpacing: '0.5px' }}
              >
                HUB
              </div>
            </div>
      ...
      {!collapsed && (
        <div
          ...
          style={{
            padding: '16px',
            margin: '12px 16px',
            background: 'linear-gradient(135deg, #f0f7ff 0%, #fffce6 100%)',
          ...
          onMouseLeave={(e) => {
            ...
            e.currentTarget.style.borderColor = '#d4e9ff'
          }}
        >
          {/* Decorative accent */}
          <div
            style={{
              ...
              width: 60,
              height: 60,
              background: 'linear-gradient(135deg, #ffdc3b 0%, #1890ff 100%)',
              opacity: 0.1,
          ...
          >
            <Badge dot color={user?.isApproved ? '#52c41a' : '#ffdc3b'} offset={[-4, 4]}>
              <Avatar
                size={48}
                src={
                ...
                style={{
                  background: user?.isApproved ? '#1890ff' : '#ffdc3b',
