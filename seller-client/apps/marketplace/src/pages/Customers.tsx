        ...
        <Card>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            <Title level={3} style={{ margin: 0 }}>
              <TeamOutlined style={{ marginRight: 8, color: '#B78115' }} /> My Customers
            </Title>
            <Text type="secondary">
          ...
          <Col xs={24} sm={12} lg={6}>
            <Card hoverable loading={isLoadingStats}>
              <Statistic
                ...
                prefix={<UserOutlined style={{ color: '#B78115' }} />}
                valueStyle={{ color: '#B78115' }}
              />
            </Card>
          </Col>
          <Col xs={24} sm={12} lg={6}>
          ...
          <Row gutter={[16, 16]}>
            <Col xs={24} md={12}>
              <Card
                title={
                  <Space>
                    <EnvironmentOutlined style={{ color: '#B78115' }} />
