import { LockOutlined, HomeOutlined, SafetyOutlined } from "@ant-design/icons";
        ...
        <Card className="shadow-2xl rounded-2xl bg-gradient-to-br from-white to-gray-50 border border-gray-200 overflow-hidden">
          <div className="text-center py-8 md:py-12 px-6 md:px-8">
            ...
            <div className="icon-container mb-6 md:mb-8">
              <div className="mx-auto flex items-center justify-center w-24 h-24 md:w-32 md:h-32 rounded-full bg-gradient-to-br from-red-500 to-red-400 shadow-lg shadow-red-500/30">
                <LockOutlined className="lock-icon text-white text-4xl md:text-5xl" />
              </div>
            </div>
            ...
            {location.pathname && (
              <div className="mb-6 md:mb-8 py-3 px-5 bg-gray-100 rounded-lg inline-block">
                <Space size="small">
                  <SafetyOutlined className="text-gray-400 text-sm" />
