...
export type CourierCartRateRequest = ShippingRateRequest
...
export type CourierCartCreateShipmentRequest = ShippingCreateShipmentRequest
...
export type CourierCartManifestRequest = ShippingManifestRequest
...
export type CourierCartCourier = ShippingCourier
...
class ShippingProviderService {
  ...
  async generateManifest(_request: {
    awbs?: string[]
    order_numbers?: string[]
    type: 'b2c' | 'b2b'
