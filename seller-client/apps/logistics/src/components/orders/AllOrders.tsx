...
const AllOrders = () => {
  ...
  const handleBulkDownload = async (type: DocumentType) => {
    ...
    try {
      ...
      const archiveName = getArchiveFileNameFromHeaders(
        headers,
        `kourier-boyz-${type}s-${new Date().toISOString().slice(0, 10)}.${isLabelDownload ? 'pdf' : 'zip'}`,
      )
      saveAs(blob, archiveName)

      const downloadedCount = Number(headers['x-kourier-boyz-document-count'] || 0)
      const missingCount = Number(headers['x-kourier-boyz-missing-count'] || 0)
      const deduplicatedCount = Number(headers['x-kourier-boyz-deduplicated-count'] || 0)
      const details = [
  ...
  const handleDownloadLabelsByWarehouse = async () => {
    ...
    try {
      ...
      const archiveName = getArchiveFileNameFromHeaders(
        headers,
        `kourier-boyz-warehouse-labels-${new Date().toISOString().slice(0, 10)}.pdf`,
      )
      saveAs(blob, archiveName)
      ...
      <>
        <Button
          ...
          sx={{
            ...
            color: isMenuOpen ? '#FFFFFF' : '#B78115',
            bgcolor: isMenuOpen ? '#B78115' : '#FFFFFF',
        ...
        >
          ...
          <Button
            ...
            sx={{
              ...
              '&:hover': {
                borderColor: '#B40312',
                backgroundColor: alpha('#B78115', 0.06),
              },
              '&:disabled': {
                borderColor: alpha('#B78115', 0.4),
                color: alpha('#B78115', 0.4),
              },
            }}
          >
          ...
          <Button
            ...
            sx={{
              ...
              textTransform: 'none',
              borderRadius: '8px',
              boxShadow: '0 12px 24px rgba(49, 2, 118, 0.22)',
              transition: 'all 200ms ease',
              '&:hover': {
                bgcolor: '#B40312',
                boxShadow: '0 14px 28px rgba(49, 2, 118, 0.28)',
              },
              '&:disabled': {
                bgcolor: alpha('#B78115', 0.4),
              },
            }}
          >
            Create Order
        ...
        >
          {filterChips.map((chip) => (
            <Chip
              ...
              sx={{
                backgroundColor: alpha('#B78115', 0.08),
                color: '#B78115',
                fontWeight: 500,
                border: `1px solid ${alpha('#B78115', 0.2)}`,
                '& .MuiChip-deleteIcon': {
                  color: alpha('#B78115', 0.6),
                  '&:hover': {
                    color: '#B78115',
                  },
                },
            ...
            >
                          ...
                          >
                            <Typography
                              sx={{
                                ...
                                fontWeight: 500,
                                color:
                                  downloadingDocumentType === item.type ? '#B78115' : '#111827',
                              }}
                            >
              ...
              <Button
                ...
                sx={{
                  ...
                  '&:hover': {
                    color: '#B78115',
                    backgroundColor: alpha('#B78115', 0.05),
                  },
                }}
              >
                Clear
