...
const GlassDropZone = styled(Paper, {
  ...
  border: `1px dashed ${active || dragging ? '#B78115' : 'rgba(17, 24, 39, 0.18)'}`,
  borderRadius: 0,
  padding: '24px',
  width: '100%',
  textAlign: 'center',
      ...
      <Stack spacing={1}>
        ...
        >
          ...
          {loadingPreview || uploading ? (
            ...
            <Stack alignItems="center" spacing={2}>
              <IoCloudUploadOutline size={46} color="#B78115" />
