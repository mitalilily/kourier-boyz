...
const TcsReport = () => {
  ...
  const {
    ...
    queryKey: ['sellerTcsReport', queryParams],
      ...
      <html>
        <head>
          ...
          <style>
            ...
            h1 { color: #333; }
            .note { margin-bottom: 20px; padding: 10px; background-color: #f0f0f0; border-left: 4px solid #B78115; }
      ...
      <Card>
        <Space direction="vertical" size="large" style={{ width: '100%' }}>
            ...
            <Row gutter={16}>
              ...
              <Col span={8}>
                <Statistic
                  ...
                  prefix="₹"
                  precision={0}
                  valueStyle={{ color: '#B78115', fontWeight: 'bold' }}
                />
              </Col>
              <Col span={8}>
          ...
          <Table
            ...
            loading={isLoading}
            rowKey={(record) =>
              `${record.customerType}-${record.supplyType}-${record.financialYear}`
            }
            scroll={{ x: 1500 }}
            pagination={{
              pageSize: 50,
                ...
                <Table.Summary fixed>
                  <Table.Summary.Row>
                    ...
                    <Table.Summary.Cell index={4} colSpan={4} align="right">
                      <strong style={{ color: '#B78115' }}>{formatCurrency(totals.totalTcs)}</strong>
                    </Table.Summary.Cell>
