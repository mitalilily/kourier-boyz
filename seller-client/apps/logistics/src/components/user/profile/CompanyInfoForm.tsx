...
export default function CompanyInfoForm() {
  ...
  return (
    ...
    >
      <Stack spacing={0.8}>
        <Typography sx={{ fontSize: '0.72rem', letterSpacing: 1.8, color: '#555D61', fontWeight: 700 }}>
          COMPANY PROFILE
        </Typography>
        ...
        <Typography sx={{ color: '#626966', fontSize: '0.92rem', maxWidth: 760 }}>
      ...
      <Grid container spacing={4}>
        ...
        <Grid size={{ md: 3, xs: 12 }} mt={2}>
          ...
          >
            ...
            <Typography sx={{ fontSize: '0.82rem', color: '#626966' }}>
            ...
            <Paper elevation={0} sx={{ p: 1.6, border: `1px solid ${alpha(BRAND_GREEN, 0.12)}`, borderRadius: 0 }}>
              <Stack direction="row" spacing={1} alignItems="center" sx={{ mb: 1.3 }}>
                ...
                <Box>
                  ...
                  <Typography sx={{ fontSize: '0.78rem', color: '#626966' }}>
