...
## Overview
This guide documents the standardized layout for all list and table pages in the Kourier Boyz logistics client, based on the B2COrdersList component pattern.
