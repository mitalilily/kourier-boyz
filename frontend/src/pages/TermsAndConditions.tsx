...
const TermsAndConditions = () => {
  const { data: agreement, isLoading, error } = useQuery({
    queryKey: ['agreement', 'customer-terms'],
    queryFn: () => getAgreementByType('customer-terms'),
    retry: false, // Don't retry on 404 - agreement simply doesn't exist yet
  })
        ...
        <div className="max-w-4xl mx-auto px-4 text-center">
          <div className="bg-white rounded-2xl shadow-lg p-12">
            ...
            <p className="text-gray-600 mb-8 text-lg">
              {error
                ? (error as Error)?.message || 'Terms and conditions are not available at this time. Please check back later or contact support.'
        ...
        <div className="relative h-64 md:h-80 bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900">
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="text-center px-4">
              <FileText className="w-12 h-12 md:w-16 md:h-16 mx-auto mb-4 text-white opacity-90" />
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 text-sm text-gray-600">
            ...
            {agreement.effectiveDate && (
              <div className="flex items-center gap-2">
                ...
                <span>{new Date(agreement.effectiveDate).toLocaleDateString('en-US', {
                  year: 'numeric',
                  month: 'long',
                  day: 'numeric',
                })}</span>
            ...
            {agreement.updatedAt && (
              <div className="flex items-center gap-2">
                ...
                <span>{new Date(agreement.updatedAt).toLocaleDateString('en-US', {
                  year: 'numeric',
                  month: 'long',
                  day: 'numeric',
                })}</span>
