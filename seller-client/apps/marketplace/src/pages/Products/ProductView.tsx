...
const ProductView = () => {
  ...
  const getWarehouseId = (addr: PickupAddressWithId, index?: number): string => {
    ...
    if (addr.kourierBoyzLogisticsPickupAddressId) return String(addr.kourierBoyzLogisticsPickupAddressId)
              ...
              <>
                ...
                {(product as ExtendedProduct).effectivePrice !== undefined && (
                  <Descriptions.Item label="Effective Price">
                    <Typography.Text strong style={{ color: '#B78115' }}>
        ...
        <Row gutter={16}>
          <Col span={6}>
            <Card size="small">
              ...
              <div style={{ fontSize: 24, fontWeight: 'bold', color: '#B78115' }}>
                {product?.rating || 0} ⭐
              </div>
            </Card>
          </Col>
                    ...
                    render: (_: unknown, record: WarehouseInventoryItem) => {
                      ...
                      const warehouse = pickupAddresses.find((addr: PickupAddress) => {
                        ...
                        return (
                          ...
                          (addrWithId.kourierBoyzLogisticsPickupAddressId &&
                            String(addrWithId.kourierBoyzLogisticsPickupAddressId) === record.warehouseId)
                        )
                      })
